  ...
  return (
    <>
      <div className="terms-wrap">
        <h1>Privacy Policy of ShareMySocials</h1>

        <p>
          ShareMySocials operates the www.sharemysocials.com website, which
        ...
        <p>
          ...
          anyone decided to use our Service, the ShareMySocials website.
        </p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at www.sharemysocials.com,
        ...
        <p>
          ...
          information that we collect will be used to contact you if needed. We
          use third party tools that might collect your data. Please check their
          privacy policies for more information: Google Analytics,Stripe
        </p>

        <p>
          {" "}
          We want to inform you that whenever you visit our Service, we are not
          collecting your data unless you "Register" or "Sign up" on our page.
          We only getting the data that you send us.
        </p>
